...
import { createKit } from "@/app/actions/kit"
...
export function AddKitDialog({ onSuccess }: AddKitDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error(result.message || "Erro ao criar kit")
      }
    } catch (error) {
