...
import { Menu, ChevronDown, Settings, User, Heart, Package, LogOut, Bell, X, Crown, Search } from "lucide-react"
    ...
    <>
      <header className="sticky top-0 z-40 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm">
        <div className="container mx-auto px-4">
          ...
          <div className="flex lg:hidden h-14 items-center justify-between">
            {/* Mobile Menu Button */}
            <Button variant="ghost" size="icon" className="p-2" onClick={() => setIsMobileMenuOpen(true)}>
          ...
          <div className="hidden lg:flex h-16 items-center justify-between">
            ...
            <div className="flex-1 max-w-md">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-2 w-full border-2 border-gray-200 focus:border-red-500 rounded-lg transition-all duration-300"
                />
              </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-end space-x-4">
              ...
              {user ? (
                ...
                <Button variant="secondary" size="sm" className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 h-10">
      ...
      {isMobileMenuOpen && (
        <>
          ...
          <div className="fixed top-0 left-0 h-full w-80 bg-white shadow-2xl z-50 lg:hidden animate-in slide-in-from-left duration-300">
            {/* Mobile Menu Header */}
